        ...
        <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center bg-white rounded-3xl md:rounded-full shadow-lg p-4 md:p-2 md:pl-6 border border-gray-200">
          ...
          <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto">
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white rounded-full p-4 flex-1 md:flex-initial md:w-auto flex justify-center items-center gap-2 transition-colors shadow-md"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <span className="font-bold text-sm">検索</span>
            </button>
            {/* 地図で探すボタン */}
            <button
              onClick={() => {
